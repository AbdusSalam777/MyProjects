const courses = [
  ...
  {
    name: "The Nazirah Teacher Course (Female)",
    ...
    image: "/images/nazrateachercoursefem.png"
  },
  {
  ...
  // {
  //   name: "The Memorization of 40 AHADITH Course (For Kids)",
  //   slug: "memorization-40-ahadith-kids",
  //   duration: "6 months",
  //   classDuration: "30 Minutes",
  //   languages: "Urdu/Roman",
  //   overview: "Memorization of 40 important Ahadith for children.",
  //   topics: [
  //     "Daily memorization",
  //     "Revision strategies",
  //     "Meaning explanation"
  //   ],
  //   demoLink: "https://faizanonline.net/memorization-40-ahadith-kids/demo-class",
  //   image: "https://faizanonline.net/admin/assets/uploads/courses_images/memorization-40-ahadith-kids_img.png?v=0.5.0"
  // },
  {
