const products = [
  ...
  {
    name: "Plain Hooded Fleece Sweatshirt for Boys ",
    price: 3500,
  ...
  {
    name: "Womens Chiffon Beachwear Cover Up ",
    price: 1560,
...
buttonSelector.forEach((button) => {
  button.addEventListener("click", () => {
    ...
    const send_Data = fetch("http://localhost:3000/cart-data", {
      method: "POST",
      headers: {
