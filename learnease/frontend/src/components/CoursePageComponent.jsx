...
function CoursePageComponent() {
  ...
  useEffect(() => {
    async function fetchCourse() {
      const res = await fetch(`https://learneasebackend-79bj.onrender.com/courses/${id}`);
  ...
  return (
    <div className="min-h-screen py-10 px-4 bg-gradient-to-b fr mt-16 overflow-x-hidden text-white">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10">
        ...
        <div className="flex-1 space-y-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-white/80">
              Course by{" "}
              <span className="underline text-blue-400">GreatStack</span>
            </p>
          </div>
            ...
            <div className="space-y-2">
              {data?.courseContent?.map((chapter) => (
                <details
                  ...
                  className="border border-white/30 rounded-lg px-4 py-2 text-white"
                >
                    ...
                    {chapter.chapterContent.map((lecture) => (
                      <li key={lecture.lectureId}>
                        ...
                        {lecture.isPreviewFree && (
                          <span className="ml-2 text-green-400 text-xs underline">
                            Preview
                          </span>
                        )}
                      </li>
          ...
          <div>
            ...
            <div
              className="prose max-w-none text-white/80 [&_ul]:list-disc [&_ul]:list-inside flex flex-col gap-2"
        ...
        <div className="order-first lg:order-last w-full sm:w-[400px] lg:w-[450px] mx-auto lg:mx-0 shrink-0 p-6">
          <div className="bg-amber-50 shadow-lg shadow-gray-600 overflow-hidden lg:top-20 text-black">
            <Sidecard data={data} />
          </div>
        </div>
      </div>
